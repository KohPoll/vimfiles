...
" cms tag
call <SID>HtmlIndentPush('cms:text')
call <SID>HtmlIndentPush('cms:textArea')
call <SID>HtmlIndentPush('cms:textLink')
call <SID>HtmlIndentPush('cms:image')
call <SID>HtmlIndentPush('cms:imageLink')
call <SID>HtmlIndentPush('cms:product')
call <SID>HtmlIndentPush('cms:custom')
call <SID>HtmlIndentPush('cms:repeat')
